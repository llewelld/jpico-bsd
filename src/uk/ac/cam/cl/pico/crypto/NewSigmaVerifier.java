...
import uk.ac.cam.cl.pico.crypto.ISigmaVerifier.Client.ClientAuthorisation;
...
public class NewSigmaVerifier implements ISigmaVerifier {
	 ...
	 * 	successful authentication (see {@link NewSigmaVerifier.Client#onAuthenticate(PublicKey)}).
	 */
	@Override
